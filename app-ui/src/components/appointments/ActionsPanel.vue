      ...
      <div class="relative w-full max-w-md bg-white shadow-xl flex flex-col">
        ...
        <div class="px-6 py-4 border-b border-slate-200">
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-800">Session Actions</h2>
          ...
          <div class="mt-2 text-sm text-slate-500">
            <p><span class="font-medium text-slate-700">{{ appointment.patient }}</span> with {{ appointment.therapist }}</p>
            <p>{{ appointment.sessionDate }} at {{ appointment.sessionTime }}</p>
          </div>
          <div class="mt-2">
